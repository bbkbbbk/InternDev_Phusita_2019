...
เหตุผลที่เลือก 2 เว็บนี้เพราะเว็บแรกคือ imdb เป็นเว็บที่รวบรวมข้อมูลเกี่ยวกับภาพยนต์ที่เป็นอะไรๆที่หลายๆคนเข้าถึงและในเว็บมีข้อมูลเกี่ยกับหนังแต่ละเรื่องที่เราสามารถ
ดึงข้อมูลออกมาได้เลย เลยได้ทำการดึงส่วนที่เป็นชื่อหนังมาเป็นคำที่จะใช้เล่นในเกม และคำอธิบายของหนังมาเป็นคำใบ้
...
<p align="center">หรือถ้าเลือกหมวดเพลงก็จะเป็นคำใบ้เป็นศิลปินที่ร้องเพลงนั้นๆด้วย โดยในที่นี้ถ้าเป็นเพลงที่ featuring กับใครเราไม่ได้เอามาใส่เป็นคำที่ใบ้ เพราะฉะนั้น user เลยแค่เดาชื่อเพลงได้เลย และคะแนนสามารถติดลบได้เพราะฉะนั้นอย่าเดามั่วๆดีกว่าา</p>
 ...
 <p align="center">
  <img width="569" alt="screen shot 2562-01-31 at 21 38 13" src="https://user-images.githubusercontent.com/47117776/52061306-94071d00-25a0-11e9-8864-eaf35a92c246.png">
<p align="center">หรือถ้าผู้เล่นรู้แล้วว่าคำนั้นคือคำอะไรก็สามารถใส่คำลงไปได้เลย โดยจะได้รับคะแนนพิเศษโดยคะแนนพิเศษนี้จะมากน้อยขึ้นอยู่กับว่าผู้เล่นได้เดาผิดไปกี่ตัว</p>
